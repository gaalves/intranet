...
class RegisterController extends Controller
{
    ...
    */
    ...
    {
        //$this->middleware('guest'); Modelo de Antes
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'email' => 'required|string|email|max:255|unique:users|regex:/^[A-Za-z0-9\.]*@(grupomed)[.](com)[.](br)$/',
     ...
     public function verifyUser($token)
    {
        ...
        if(isset($verifyUser) ){
            ...
            if(!$user->verified) {
                ...
                $status = "Seu e-mail é verificado. Agora você pode fazer o login.";
            }else{
